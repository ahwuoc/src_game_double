...
public class ConstNpc {
    ...
    public static final byte NARUTO = 78;
    public static final byte BERRY = 71;
    public static final byte cadich = 75;    
    public static final byte hatsu = 79;
    public static final byte kaioshin = 80;
    public static final byte facebook = 81;
    public static final byte SUKIEN = 82;
    public static final byte LEO_THAP = 83;
    public static final byte Granola = 96;
    public static final byte QuaTrungLinhThu = 97;
    //----------------------index menu------------------------------------------
    //menu o len tang map mabu
    public static final int GO_UPSTAIRS_MENU = 10000;
    public static final int MENU_PHAN_RA_LINH_THU = 23092007;
    ...
    //index Naruto
    public static final int MENU_NARUTO = 6000;
    ...
    //index menu con meo
    public static final int SUMMON_DRAGON_SIEU_CAP = 540;
    ...
    public static final int SUMMON_DRAGON_SIEU_CAP_MENU = 541;
    ...
    public static final int SUMMON_BLACK_SHENRON = 518;
    ...
    public static final int maydoboss = 251004;
    public static final int PKALL = 251005;
    public static final int ghepmanhtrung = 251006;
    public static final int ghepsachchiendau = 251007;
    public static final int huongdan = 251008;
    public static final int MENU_HO_TONG = 251009;
    public static final int MENU_LEO_THAP = 251010;
    public static final int SHOP_LEO_THAP = 251011;
    public static final int ghepmatgiatoc = 251012;
}
