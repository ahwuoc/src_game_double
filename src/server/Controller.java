...
import services.PhucLoiService;
...
public class Controller implements IMessageHandler {
    ...
    public void onMessage(ISession s, Message _msg) {
        ...
        try {
            ...
            switch (cmd) {
                case 70:
                    PhucLoiService.readMSG(player, _msg);
                    break;
                case -120:
                ...
                case -113:
                    ...
                    break;
                case -101:
                    Service.gI().switchToRegisterScr(_session);
...
//                 test
    ...
    public void login2(MySession session, Message msg) {
        ...
        Service.gI().sendThongBaoOK(session, "Vui lòng đăng ký tài khoản tại: HTTPS://DRAGONBALLDAGA.VN");
    }
    ...
    private void sendThongBaoServer(Player player) {
        String s = "Sự kiện Giải cứu nhẫn giới và đại chiến thần thú đang diễn ra, hãy tới gặp Naruto tại Vách núi đen và Bery tại Đảo Kame để biết thêm chi tiết";
