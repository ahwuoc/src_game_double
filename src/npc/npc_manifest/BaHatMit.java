                    ...
                    switch (player.iDMark.getIndexMenu()) {
                        case ConstNpc.BASE_MENU -> {
                            switch (select) {
                                ...
                                case 6 ->
                                    createOtherMenu(player, ConstMenu.MENU_KHAM, "Ta có thể giúp gì cho ngươi ?", "Đục Khảm\nLỗ","Ép Khảm\n lỗ");
                            }
                        }
                        ...
                        case ConstNpc.MENU_START_COMBINE -> {
                            switch (player.combine.typeCombine) {
                                ...
                                case CombineService.NANG_CAP_KICH_HOAT_VIP, CombineService.NANG_CAP_KICH_HOAT, CombineService.NANG_CAP_SAO_PHA_LE, CombineService.DANH_BONG_SAO_PHA_LE, CombineService.CUONG_HOA_LO_SAO_PHA_LE, CombineService.TAO_DA_HEMATITE, CombineService.EP_SAO_TRANG_BI,CombineService.NANG_CAP_CHAN_MENH,CombineService.MO_CHI_SO_CAI_TRANG,CombineService.XOA_SPL,CombineService.DUC_LO_KHAM , CombineService.KHAM_EP_DA-> {
                                    switch (select) {
                                        case 0:
                                            CombineService.gI().startCombine(player);
                                            break;
