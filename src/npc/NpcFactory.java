    ...
    public static Npc createNPC(int mapId, int status, int cx, int cy, int tempId) {
        ...
        try {
            return switch (tempId) {
                ...
                case ConstNpc.QuaTrungLinhThu ->
                    new QuaTrungLinhThu(mapId, status, cx, cy, tempId, avatar);
                ...
                case ConstNpc.LEO_THAP -> new LeoThap(mapId, status, cx, cy, tempId, avatar);
                default ->
                    ...
                    case ConstNpc.ghepsachchiendau -> {
                        if (InventoryService.gI().getCountEmptyBag(player) > 0) {
                            ...
                            if (manhTrung != null && manhTrung.quantity >= 999) {
                                ...
                                trungThuong.itemOptions.add(new Item.ItemOption(50, Util.nextInt(50, 140)));
                                trungThuong.itemOptions.add(new Item.ItemOption(77, Util.nextInt(50, 140)));
                                trungThuong.itemOptions.add(new Item.ItemOption(103, Util.nextInt(50, 140)));
                                trungThuong.itemOptions.add(new Item.ItemOption(210, Util.nextInt(1, 5)));
                                trungThuong.itemOptions.add(new Item.ItemOption(72, Util.nextInt(1, 5)));

                                trungVip.itemOptions.add(new Item.ItemOption(50, Util.nextInt(60, 150)));
                                trungVip.itemOptions.add(new Item.ItemOption(77, Util.nextInt(60, 150)));
                                trungVip.itemOptions.add(new Item.ItemOption(103, Util.nextInt(60, 150)));
                                trungVip.itemOptions.add(new Item.ItemOption(237, Util.nextInt(1, 5)));
                                trungVip.itemOptions.add(new Item.ItemOption(204, Util.nextInt(1, 20)));
                                trungVip.itemOptions.add(new Item.ItemOption(72, Util.nextInt(1, 8)));
                                ...
                                Service.getInstance().sendThongBao(player, "Cần x999 Mảnh Sách Chiến Đấu.");
                            }
                        } else {
                            Service.getInstance().sendThongBao(player, "Hãy chừa 1 ô trống để mở.");
                        }
                     ...
                     case ConstNpc.ghepmatgiatoc -> {
                        if (InventoryService.gI().getCountEmptyBag(player) > 0) {
                            Item manhTrung = InventoryService.gI().findItemBag(player, 1179);
                            if (manhTrung != null && manhTrung.quantity >= 999) {
                                Item trungThuong = ItemService.gI().createNewItem((short) 1180, 1);
                                Item trungVip = ItemService.gI().createNewItem((short) 1181, 1);
                                trungThuong.itemOptions.add(new Item.ItemOption(50, Util.nextInt(50, 90)));
                                trungThuong.itemOptions.add(new Item.ItemOption(77, Util.nextInt(50, 90)));
                                trungThuong.itemOptions.add(new Item.ItemOption(103, Util.nextInt(50, 90)));
                                trungThuong.itemOptions.add(new Item.ItemOption(210, Util.nextInt(1, 5)));
                                trungThuong.itemOptions.add(new Item.ItemOption(72, Util.nextInt(1, 5)));

                                trungVip.itemOptions.add(new Item.ItemOption(50, Util.nextInt(50, 120)));
                                trungVip.itemOptions.add(new Item.ItemOption(77, Util.nextInt(50, 120)));
                                trungVip.itemOptions.add(new Item.ItemOption(103, Util.nextInt(50, 120)));
                                trungVip.itemOptions.add(new Item.ItemOption(237, Util.nextInt(1, 5)));
                                trungVip.itemOptions.add(new Item.ItemOption(204, Util.nextInt(1, 20)));
                                trungVip.itemOptions.add(new Item.ItemOption(72, Util.nextInt(1, 8)));
                                if (Util.isTrue(80, 100)) {
                                ...
                                Service.getInstance().sendThongBao(player, "Cần x999 Mảnh .");
                            }
                        } else {
                            Service.getInstance().sendThongBao(player, "Hãy chừa 1 ô trống để mở.");
                        }
                    ...
                    case ConstNpc.SUMMON_DRAGON_SIEU_CAP_MENU -> {
                        switch (select) {
                            case 0, 1, 2:
                                ...
                                it.addOptionParam(50, 100);
                                it.addOptionParam(77, 100);
                                it.addOptionParam(103, 100);
                                it.addOptionParam(94, 15);
                                it.addOptionParam(192, 100);
