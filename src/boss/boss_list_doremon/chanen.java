...
public class chanen extends Boss {

    private long st;

    public chanen() throws Exception {
        super(BossID.chanen, false, true, BossesData.chanen);
    }
    ...
    public void reward(Player plKill) {
        ...
        for (int i = 0; i < slcarot; i++) {
            ItemMap carot = new ItemMap(zone, 864, 1, 10 * i + this.location.x, zone.map.yPhysicInTop(this.location.x, 0), -1);
            carot.options.add(new ItemOption(50, Util.nextInt(5, 90)));
            carot.options.add(new ItemOption(77, Util.nextInt(1, 90)));
            carot.options.add(new ItemOption(103, Util.nextInt(1, 90)));
