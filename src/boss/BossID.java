...
public class BossID {
    ...
    //========================NHAN GIOI========================
    public static final int CUU_VI = -6000;
    public static final int OBITO = -6001;
    public static final int OBITO_LUC_DAO = -6002;
    public static final int OBITO_LUC_DAO1 = 6002;

    //========================DAI CHIEN THAN THU========================
    public static final int HAI_KHUYEN = -6003;
    public static final int BACH_LANG = -6004;
    public static final int THIET_MA = -6005;
    public static final int VUA_BACH_THU = -6006;
...
//    public static final int DOI_TRUONG_5 = -339;
    ...
    //======================LÀM THÊM========================
    public static final int NGUSAC = 1;
    public static final int ZAMASU = 2;
    public static final int KELA = 3;
    public static final int OBITOVIP = 4;
    public static final int FU = 5;
    public static final int XETANG390 = 6;
    public static final int BLACKGOKU = 7;
    public static final int BLACKGOKUROSE = 8;
    public static final int doremon = 9;
    public static final int nobita = 10;
    public static final int xuka = 11;
    public static final int xeko = 12;
    public static final int chanen = 13;
    public static final int pan = 14;
    public static final int vithu1 = 15;
    public static final int vithu2 = 16;
    public static final int vithu3 = 17;
    public static final int vithu4 = 18;
    public static final int vithu5 = 19;
    public static final int vithu6 = 20;
    public static final int vithu7 = 21;
    public static final int vithu8 = 22;
    public static final int vithu9 = 23;
    public static final int BOSSNGOCRONG = 24;
     public static final int cogiaothao = 25;
     public static final int tokuda = 26; // mẫu
 public static final int conmemay = 27; // mẫu
   public static final int NYCTHAO = 28; // mẫu
   public static final int NYCLOAN = 29; // mẫu
    public static final int KALI3QUE = 30; // mẫu
     public static final int CONCAK = 31; // mẫu
      public static final int bosskeyvang = 32; // mẫu
      public static final int LUFFI = 33; // mẫu
      public static final int SANJI = 34; 
       public static final int BOSSADMIN = 36; 
      public static final int broly1 = 37; 
   public static final int death_bean1 = 38;
    public static final int death_bean2 = 39;
    public static final int death_bean3 = 40;
    public static final int death_bean4 = 41;
    public static final int death_bean5 = 42;
     public static final int vlxx = 43;
      public static final int sex = 44;
