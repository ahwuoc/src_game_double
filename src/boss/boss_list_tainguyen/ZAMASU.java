...
public class ZAMASU extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        for (int i = 1; i < Util.nextInt(5, 20) + 1; i++) {
            Service.gI().dropItemMap(this.zone, new ItemMap(zone, 20, 1, this.location.x - i * 10, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), plKill.id));
        }
       
        short[] itemIds = {1283,1495,1530,1291,1461,16}; // danh sách id bạn muốn
