...
public class SuperBroly extends Boss {
    ...
    public void reward(Player plKill) {
        // ItemMap it = new ItemMap(this.zone, 568, 1, this.location.x + Util.nextInt(-15, 15), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
        // Service.gI().dropItemMap(this.zone, it);
        if(plKill.pet == null){
            PetService.gI().createNormalPet(plKill);
            Service.gI().sendThongBao(plKill, "Bạn nhận được đệ tử!");
        }
    }
    ...
    public void joinMap() {
        ...
        //PetService.gI().createMabuPet(this, 1);
