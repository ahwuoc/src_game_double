...
public class SuperBrolyNew extends Boss {
    ...
    public void reward(Player plKill) {
        // ItemMap it = new ItemMap(this.zone, 568, 1, this.location.x + Util.nextInt(-15, 15),
    ...
    public void joinMap() {
        ...
        this.nPoint.hpMax = Util.nextInt(2_000_000, 16_070_777);
    ...
    public void leaveMap() {
        ...
        BossManager.gI().createBossBroly(BossID.BROLY, 10000);
        this.dispose();
    }
}
