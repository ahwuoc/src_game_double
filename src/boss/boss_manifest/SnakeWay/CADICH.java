...
public class CADICH extends Boss {
    ...
    public CADICH(Zone zone, Clan clan, double dame, double hp) throws Exception {
    ...
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(30, 100)) {
            ItemMap it = new ItemMap(this.zone, 1143, Util.nextInt(10,20), this.location.x, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), plKill.id);
            Service.gI().dropItemMap(this.zone, it);
        }
