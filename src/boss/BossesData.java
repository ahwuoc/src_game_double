...
public class BossesData {
    ...
    public static final BossData KUKU = new BossData(
      ...
      public static final BossData cogiaothao = new BossData(
            "cogiaothao", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1234, 1235, 1236, -1, 175, -1}, // outfit {head, body, leg, bag, aura, eff}
            900000, // dame
            new double[]{6_000000_000l}, // hp
            new int[]{68, 69, 70, 71, 72}, // map join
            new int[][]{
                {Skill.MASENKO, 3, 1000},
                {Skill.LIEN_HOAN, 7, 1000}},
     ...
     public static final BossData tokuda = new BossData(
            "tokuda", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1408, 1409, 1410, -1, 236, -1}, // outfit {head, body, leg, bag, aura, eff}
            900000, // dame // chinh dame
            new double[]{6_000000_000l}, // hp chinh 
            new int[]{68, 69, 70, 71, 72}, // map join
            new int[][]{
                {Skill.MASENKO, 3, 1000},
                {Skill.LIEN_HOAN, 7, 1000}},
    ...
    public static final BossData NGUSAC = new BossData(
            "Android 21 Majin Form", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1470, 1471, 1472, 184, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            13000000, // dame
            new double[]{5_00000_000_000l}, // hp
            new int[]{180}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
                { Skill.KAMEJOKO, 7, 100 },
                { Skill.KHIEN_NANG_LUONG, 7, 80000 },
                {Skill.THAI_DUONG_HA_SAN, 7, 40000},
                {Skill.SOCOLA, 7, 50000},
      ...
      public static final BossData BOSSNGOCRONG = new BossData(
            "Boss Ngọc Rồng", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1903,	1904,	1905, 208, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            130000, // dame
            new double[]{3_00000_000_000l}, // hp
            new int[]{6,7,8,15}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
                { Skill.KAMEJOKO, 7, 100 },
     ...
     public static final BossData ZAMASU = new BossData(
            "Fusion Zamasu", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1249,	1250	,1251, 33, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            11000000, // dame
            new double[]{3_500_00000_000l}, // hp
      ...
      public static final BossData KELA = new BossData(
            "Kale broly", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1387	,1388,	1389, 184, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            15000000, // dame
            new double[]{6_80000_000_000l}, // hp
       ...
       public static final BossData bosskeyvang = new BossData(
            "bosskeyvang", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1288,1289,1290, 184, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            15000000, // dame
            new double[]{6_80000_000_000l}, // hp
            new int[]{104}, // map join
            new int[][]{
      ...
      public static final BossData OBITOVIP = new BossData(
            "Obito", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1755	,1756,	1757, 170, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            19000000, // dame
            new double[]{8_40000_000_000l}, // hp
            ...
            REST_1_M // second res
               ...
               public static final BossData NYCTHAO = new BossData(
            "NYCTHAO", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1399	,1400,	1401, 170, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            19000000, // dame
            new double[]{8_40000_000_000l}, // hp
            new int[]{181}, // map join
            new int[][]{
      ...
      public static final BossData FU = new BossData(
            "Fu Morito", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1674,1675,	1676, 185, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            29000000, // dame
            new double[]{10_40000_000_000l}, // hp
            new int[]{181}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
      ...
      public static final BossData LUFFI = new BossData(
            "LUFFI", // name
            ConstPlayer.XAYDA, // gender
            new short[]{582,583,584, 185, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            2900000000L, // dame
            new double[]{10_40000_000_000l}, // hp
            new int[]{181,5,7,15,123,9}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
                { Skill.KAMEJOKO, 7, 100 },
       ...
       public static final BossData SANJI = new BossData(
        ...
        public static final BossData BOSSADMIN = new BossData(
            "BOSSADMIN", // name
            ConstPlayer.XAYDA, // gender
            new short[]{907,908,909, 185, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            2900000000L, // dame
            new double[]{10_40000_000_00000000000000D}, // hp
            new int[]{181,5,7,15,123,9}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
     ...
     public static final BossData XETANG390 = new BossData(
            "Xe Tăng 390", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1536,1537,	1538, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            6600000, // dame
            new double[]{1_00000_000_000l}, // hp
            new int[]{17,18,19,20,25,26,27,30,31,35,36}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
                { Skill.KAMEJOKO, 7, 100 },
       ...
       public static final BossData pan = new BossData(
            "Pan SKH VIP", // name
            ConstPlayer.XAYDA, // gender
            new short[]{693,	694,	695, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            660000, // dame
            new double[]{1_00000_000_000l}, // hp
            new int[]{17,18,19,20,25,26,27,30,31,35,36}, // map join
            new int[][]{
      ...
      public static final BossData bossskhts = new BossData(
            "bossskhts", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1674,1675,1676, 185, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            660000, // dame
            new double[]{1_00000_000_00000l}, // hp
            new int[]{17,18,19,20,25,26,27,30,31,35,36}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
        ...
        public static final BossData BLACKGOKU = new BossData(
            "Siêu Black Goku", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1909,1911,	1912, 129, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            59000000, // dame
            new double[]{13_40000_000_000l}, // hp
       ...
       public static final BossData BLACKGOKUROSE = new BossData(
            "Siêu Black Goku", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1910,1911,	1912, 129, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            89000000, // dame
            new double[]{18_400_00000_000l}, // hp
            new int[]{92,93,94,96,97,98,99,100}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
       ...
       public static final BossData KALI3QUE = new BossData(
            "KALI3QUE", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1530,1531,1532, 129, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            89000000, // dame
            new double[]{18_400_00000_000l}, // hp
            new int[]{92,93,94,96,97,98,99,100}, // map join
            new int[][]{
      ...
      public static final BossData NYCLOAN = new BossData(
            "NYCLOAN", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1497,1498,1499, 129, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            89000000, // dame
            new double[]{18_400_00000_000l}, // hp
            new int[]{92,93,94,96,97,98,99,100}, // map join
            new int[][]{
     ...
     public static final BossData doremon = new BossData(
            "Đô Rê Mon", // name
            ConstPlayer.XAYDA, // gender
            new short[]{790,	791,	792, 129, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            1, // dame
            new double[]{10}, // hp
            new int[]{19}, // map join
            new int[][]{
    ...
    public static final BossData nobita = new BossData(
            "nobita", // name
            ConstPlayer.XAYDA, // gender
            new short[]{844	,845,	846, 129, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            99000000, // dame
            new double[]{37_40000_000_000l}, // hp
            new int[]{19}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
      ...
      public static final BossData xuka = new BossData(
            "xuka", // name
            ConstPlayer.XAYDA, // gender
            new short[]{802	,803,	804, 129, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            99000000, // dame
            new double[]{45_40000_000_000l}, // hp
            new int[]{19}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
       ...
       public static final BossData xeko = new BossData(
            "xeko", // name
            ConstPlayer.XAYDA, // gender
            new short[]{850,	851,	852, 129, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            109000000, // dame
            new double[]{53_40000_000_000l}, // hp
            new int[]{19}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
         ...
         public static final BossData chanen = new BossData(
            "chanen", // name
            ConstPlayer.XAYDA, // gender
            new short[]{847	,848,	849, 129, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            129000000, // dame
            new double[]{66_40000_000_000l}, // hp
            new int[]{19}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
        ...
        public static final BossData vithu1 = new BossData(
            "Vĩ Thú 1", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1913,	1914	,1915, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            189000000, // dame
            new double[]{70_40000_000_000l}, // hp
      ...
      public static final BossData vithu2 = new BossData(
            "Vĩ Thú 2", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1916	,1917,	1918, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            189000000, // dame
            new double[]{9000_400_000_000l}, // hp
         new int[]{63,64,65,66,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
     ...
     public static final BossData vithu3 = new BossData(
            "Vĩ Thú 3", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1919	,1920,	1921, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            189000000, // dame
            new double[]{12000_400_000_000l}, // hp
          new int[]{63,64,65,66,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
       ...
       public static final BossData vithu4 = new BossData(
            "Vĩ Thú 4", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1922	,1923,	1924, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            189000000, // dame
            new double[]{150_40000_000_000l}, // hp
           new int[]{63,64,65,66,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
            ...
            REST_1_M // second rest
              ...
              public static final BossData vithu5 = new BossData(
            "Vĩ Thú 5", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1925	,1926,	1927, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            1890000, // dame
            new double[]{180_400_000_000l}, // hp
           new int[]{63,64,65,66,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
         ...
         public static final BossData vithu6 = new BossData(
            "Vĩ Thú 6", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1928	,1929,	1930, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            189000000, // dame
            new double[]{200_40000_000_000l}, // hp
            new int[]{63,64,65,66,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
         ...
         public static final BossData vithu7 = new BossData(
            "Vĩ Thú 7", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1931	,1932,	1933, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            189000000, // dame
            new double[]{230_40000_000_000l}, // hp
            new int[]{63,64,65,66,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
         ...
         public static final BossData vithu8 = new BossData(
            "Vĩ Thú 8", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1934	,1935,	1936, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            189000000, // dame
            new double[]{260_40000_000_000l}, // hp
          new int[]{63,64,65,66,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
         ...
         public static final BossData vithu9 = new BossData(
            "Vĩ Thú 9", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1937	,1938,	1939, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            189000000, // dame
            new double[]{298_40000_000_000l}, // hp
            new int[]{63,64,65,66,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
          ...
          public static final BossData sex = new BossData(
            "sex", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1213,1214,1215, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            189000000, // dame
            new double[]{298_40000_000_000l}, // hp
            new int[]{122,123,124,156,157,158}, // map join
            new int[][]{
                {Skill.MASENKO, 7, 1000},
                { Skill.ANTOMIC, 7, 1000 },
                { Skill.KAMEJOKO, 7, 100 },
...
//    );  
      ...
      public static final BossData vlxx = new BossData(
            "vlxx", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1186	,1193,	1194, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            189000000, // dame
            new double[]{298_40000_000_000l}, // hp
            new int[]{63,64,65,66,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83}, // map join
            new int[][]{
    ...
    public static final BossData BLACK_GOKU = new BossData(
            ...
            10000000, // dame
            new double[]{1_500_000_00000L}, // hp
    ...
    public static final BossData CUMBER = new BossData(
            ...
            10000000, // dame
            new double[]{1_50000_000_000L}, // hp
    ...
    public static final BossData CADIC = new BossData(
            ...
            10000000, // dame
            new double[]{2_00000_000_000L}, // hp
            new int[]{119}, // map join
            new int[][]{
                {Skill.GALICK, 7, 1000},
                {Skill.ANTOMIC, 7, 1000},
    ...
    public static final BossData SUPER_BOJACK = new BossData(
            ...
            30000000, // dame
            new double[]{1_000_000_00000L}, // hp
            new int[]{3, 4, 5, 6, 27, 28, 29, 30}, // map join
            new int[][]{
                {Skill.THOI_MIEN, 7, 100000},
                {Skill.KHIEN_NANG_LUONG, 7, 100000},
...
//    );
    ...
    public static final BossData COOLER_2 = new BossData(
            ...
            5000000, // dame
            new double[]{3_000_000_00000L}, // hp
            new int[]{110}, // map join
            (int[][]) Util.addArray(FULL_ANTOMIC, FULL_KAMEJOKO, FULL_MASENKO, FULL_GALICK), // skill
            new String[]{"|-1|Ta sẽ cho chúng bây biết sức mạnh thực sự của dân tộc Frost Demons"
            }, // text chat 1
     ...
     public static final BossData CONCAK = new BossData(
            "CONCAK", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1282, 1283, 1284, 128, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            20000000, // dame
           new double[]{1_00000_000_000L}, // hp
            new int[]{3,5,7}, // map join
            new int[][]{
            ...
            new String[]{"|-1|He he he",
                ...
                "|-1|Xem các ngươi mạnh đến đâu"}, // text chat 2
            new String[]{}, // text chat 3
            REST_1_M,            new int[]{BossID.DEATH_BEAM_1, BossID.DEATH_BEAM_2, BossID.DEATH_BEAM_3, BossID.DEATH_BEAM_4,
                BossID.DEATH_BEAM_5});
    
    public static final BossData CUU_VI = new BossData(
            "Cửu vĩ", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1476, 1477, 1478, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            200000, // dame
            new double[]{100_000_00000L}, // hp
            new int[]{5, 6, 13, 19, 20, 29, 30, 33, 34, 37}, // map join
            (int[][]) Util.addArray(FULL_ANTOMIC, FULL_KAMEJOKO, FULL_MASENKO, FULL_GALICK), // skill
            new String[]{"|-1|Cửu vĩ tựa mây hồng"
            }, // text chat 1
            new String[]{"|-1|Ta sẽ hủy diệt làng lá Aaaa",
                "|-1|Bom vĩ thú",
                "|-1|Nên giải quyết con sâu nào trước đây",
                "|-1|HA HA HA",
                "|-1|Bố mày là cửu vĩ hồ",
                "|-1|Vào hết đây mấy con lợn",
                "|-1|Ta là bất khả chiến bại",}, // text chat 2
            new String[]{"|-1|Không thể nào",
                "|-1|Hãy trả thù cho ta Obito"}, // text chat 3
            REST_15_M, // second rest
            new int[]{BossID.OBITO}
    );
    public static final BossData OBITO = new BossData(
            "OBITO", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1755, 1756, 1757, 171, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            5000000, // dame
            new double[]{30000_000_000L}, // hp
            new int[]{11, 12, 13, 18, 19, 20, 27, 28, 29, 30, 31, 33, 34, 35, 36, 37, 38}, // map join
            new int[][]{
                {Skill.GALICK, 7, 1000},
                {Skill.KAMEJOKO, 7, 3000},
                {Skill.DICH_CHUYEN_TUC_THOI, 7, 30000},
                {Skill.TAI_TAO_NANG_LUONG, 7, 120_000},},
            new String[]{"|-1|Ta là OBITO đại nhân"
            }, // text chat 1
            new String[]{"|-1|Các ngươi nghĩ có thể cản được ta sao",
                "|-1|Kamui",
                "|-1|Mang đệ tứ đến đây",
                "|-1|Cửu vĩ đâu hãy tiêu diệt bọn chúng",
                "|-1|Sức mạnh của ta là tuyệt đối HAHAHA",
                "|-1|Bộc la thiên tinh",
                "|-1|Ta là bất khả chiến bại",}, // text chat 2
            new String[]{"|-1|Nãy giờ ta chưa thèm tung hết sức đâu",
                "|-1|Hóa Lục Đạo Yahhhhhhh"}, // text chat 3
            REST_30_M, // second rest,
            AppearType.APPEAR_WITH_ANOTHER,
            new int[]{BossID.OBITO_LUC_DAO}
    );
    public static final BossData OBITO_LUC_DAO = new BossData(
            "OBITO Lục Đạo", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1758, 1759, 1760, 140, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            1200000, // dame
            new double[]{50000_000_000L}, // hp
            new int[]{110}, // map join
            // skill
            new int[][]{
                ...
                {Skill.DICH_CHUYEN_TUC_THOI, 7, 30000},
                {Skill.TAI_TAO_NANG_LUONG, 7, 120_000},
                {Skill.QUA_CAU_KENH_KHI, 7, 15_000}
            },
            new String[]{"|-1|Ta là OBITO đại nhân"
            }, // text chat 1
            new String[]{"|-1|Các ngươi nghĩ có thể cản được ta sao",
                ...
                "|-1|Bộc la thiên tinh",
                "|-1|Ta là bất khả chiến bại",}, // text chat 2
            new String[]{"|-1|Đáng ghét, không thể như thế được",
                "|-1|Ước mơ hủy diệt thế giới của ta!"}, // text chat 3
            REST_30_M,
            AppearType.CALL_BY_ANOTHER
    );
     public static final BossData OBITO_LUC_DAO1 = new BossData(
            "OBITO_LUC_DAO1", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1758, 1759, 1760, 140, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            1200000, // dame
            new double[]{50000_000_000L}, // hp
            new int[]{110,0,1,99,5}, // map join
            // skill
            new int[][]{
                {Skill.GALICK, 7, 500},
                {Skill.KAMEJOKO, 7, 2000},
    ...
    public static final BossData HAI_KHUYEN = new BossData(
            "Hải Khuyển", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1593, 1594, 1595, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            200000, // dame
            new double[]{350_000_00000L}, // hp
            new int[]{62, 63, 64, 65, 66, 67, 68, 71, 72, 76, 77}, // map join
            (int[][]) Util.addArray(FULL_ANTOMIC, FULL_KAMEJOKO, FULL_MASENKO, FULL_GALICK), // skill
            new String[]{"|-1|Nổi dậy nào anh em"
            }, // text chat 1
            new String[]{"|-1|Húuuuuuu",
                "|-1|Cú đớp của Hải Khuyển",
                "|-1|Muốn chết thì cứ bơi vào đây",
                "|-1|Go Go Go",
                "|-1|Đại Hồng Thủy ",
                "|-1|Ta sẽ nhấn chìm các ngươi hahaha",
                "|-1|Khôn hồn thì mau biến đi",}, // text chat 2
            new String[]{"|-1|Ta không thể bị đánh bại",
                "|-1|Hãy đợi đó ta sẽ quay trở lại"}, // text chat 3
            REST_15_M // second rest
    );
    public static final BossData BACH_LANG = new BossData(
            "Bạch Lang", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1596, 1597, 1598, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            200000, // dame
            new double[]{35000_000_000L}, // hp
            new int[]{62, 63, 64, 65, 66, 67, 68, 71, 72, 76, 77}, // map join
            (int[][]) Util.addArray(FULL_ANTOMIC, FULL_KAMEJOKO, FULL_MASENKO, FULL_GALICK), // skill
            new String[]{"|-1|Nổi dậy nào anh em"
            }, // text chat 1
            new String[]{"|-1|Húuuuuuu",
                "|-1|Móng vuốt Bạch Lang",
                "|-1|Muốn chết thì cứ bơi vào đây",
                "|-1|Hôm nay trăng tròn thật Hahaha",
                "|-1|Ta sẽ xé xác các ngươi hahaha",
                "|-1|Khôn hồn thì mau biến đi",}, // text chat 2
            new String[]{"|-1|Ta không thể bị đánh bại",
                "|-1|Hãy đợi đó ta sẽ quay trở lại"}, // text chat 3
            REST_15_M // second rest
    );
    public static final BossData THIET_MA = new BossData(
            "Thiết Mã", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1599, 1600, 1601, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            200000, // dame
            new double[]{350_00000_000L}, // hp
            new int[]{62, 63, 64, 65, 66, 67, 68, 71, 72, 76, 77}, // map join
            (int[][]) Util.addArray(FULL_ANTOMIC, FULL_KAMEJOKO, FULL_MASENKO, FULL_GALICK), // skill
            new String[]{"|-1|Nổi dậy nào anh em"
            }, // text chat 1
            new String[]{"|-1|Ố Ố Ố",
                "|-1|Có con Ngựa Ô Ngựa Ô",
                "|-1|Ngàn năm thương nhớ",
                "|-1|Đất Nước",
                "|-1|Có bao bài ca ngàn năm thương nhớ",
                "|-1|Nhớ con Ngựa Ô Ngựa Ô",
                "|-1|Để anh đón nàng",}, // text chat 2
            new String[]{"|-1|Ta không thể bị đánh bại",
                "|-1|Hãy đợi đó ta sẽ quay trở lại"}, // text chat 3
            REST_15_M // second rest
    );
    public static final BossData VUA_BACH_THU = new BossData(
            "Vua Bách Thú", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1285, 1286, 1287, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            200000, // dame
            new double[]{1_000_000_00000L}, // hp
            new int[]{62, 63, 64, 65, 66, 67, 68, 71, 72, 76, 77}, // map join
            (int[][]) Util.addArray(FULL_ANTOMIC, FULL_KAMEJOKO, FULL_MASENKO, FULL_GALICK, FULL_LIENHOAN), // skill
            new String[]{"|-1|Nổi dậy nào anh em"
            }, // text chat 1
            new String[]{"|-1|Vạn vật đều phải đầu hàng dưới chùy của ta",
                "|-1|Hừm hết rượu rồi sao",
                "|-1|Mang rượu tới đây cho ta",
                "|-1|Ta sẽ tiêu diệt hết đám bọn bay",
                "|-1|Chùy Bạch Ngân 1 Chùy cân tất",}, // text chat 2
            new String[]{"|-1|Các ngươi nghĩ đã hạ được ta sao",
                "|-1|Rồi có ngày ta sẽ quay trở lại"}, // text chat 3
            REST_15_M // second rest
    );
    ...
    public static final BossData GOLDEN_FRIEZA = new BossData(
            ...
            new int[]{BossID.DEATH_BEAM_1, BossID.DEATH_BEAM_2, BossID.DEATH_BEAM_3, BossID.DEATH_BEAM_4,
                BossID.DEATH_BEAM_5});
    public static final BossData broly1 = new BossData(
            "broly1", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1500, 1501, 1502, -1, 1, -1}, // outfit {head, body, leg, bag, aura, eff}
            100000000, // dame
            new double[]{1_00000_000_000L}, // hp
            new int[]{0,1,14,}, // map join
            new int[][]{
                {Skill.TAI_TAO_NANG_LUONG, 1, 120000}, {Skill.GALICK, 7, 1000},
                {Skill.KAMEJOKO, 1, 1000}, {Skill.KAMEJOKO, 2, 1000},
                {Skill.KAMEJOKO, 3, 1000}, {Skill.KAMEJOKO, 4, 1000},
                ...
                {Skill.ANTOMIC, 7, 1000},}, // skill
            new String[]{}, // text chat 1
            new String[]{"|-1|admin đẹp trai nhất thế giới",
                "|-1|mày biết bố mày là ai không",
                "|-1|mấy thằng gà biết cái đéo gì"}, // text chat 2
            new String[]{}, // text chat 3
            REST_1_M,
            new int[]{BossID.death_bean1, BossID.death_bean2, BossID.death_bean3, BossID.death_bean4,
                BossID.death_bean5});
