...
//            case YARDART ->
    ...
    public short getHead() {
        ...
        return (short) this.data[this.currentLevel].getOutfit()[0];
    }
    ...
    public short getBody() {
        ...
        return (short) this.data[this.currentLevel].getOutfit()[1];
    }
    ...
    public short getLeg() {
        ...
        return (short) this.data[this.currentLevel].getOutfit()[2];
    ...
    public short getFlagBag() {
        ...
        return (short) this.data[this.currentLevel].getOutfit()[3];
    }
    ...
    public void die(Player plKill) {
        if (plKill != null) {
            reward(plKill);
            if(plKill.notiKillBoss) ServerNotify.gI().notify(plKill.name + ": Đã tiêu diệt được " + this.name + " mọi người đều ngưỡng mộ.");
        }
