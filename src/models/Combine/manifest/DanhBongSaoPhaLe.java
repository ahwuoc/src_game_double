...
public class DanhBongSaoPhaLe {
    ...
    public static void danhBongSaoPhaLe(Player player) {
        ...
        if (Util.isTrue(30, 100)) {
            ...
            int tempId = saoPhaLeC2.template.id == 1409 ? 1731 : saoPhaLeC2.template.id == 1410 ? 1732 : saoPhaLeC2.template.id + 9;
            ...
            InventoryService.gI().addItemBag(player, saoPhaLeLapLanh,999999);
            Util.setTimeout(() -> {
