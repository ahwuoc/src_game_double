    ...
    public static void nangCapSachTuyetKy(Player player) {
        ...
        if (Util.isTrue(10, 100)) {
            switch (sachTuyetKy.template.id) {
                case 1383 ->
                    sachTuyetKy.template = ItemService.gI().getTemplate(1384);
                case 1385 ->
                    sachTuyetKy.template = ItemService.gI().getTemplate(1386);
                case 1387 ->
                    sachTuyetKy.template = ItemService.gI().getTemplate(1388);
            }
