...
public class CheTaoCuonSachCu {
    ...
    public static void showCombine(Player player) {
        Item trangSachCu = InventoryService.gI().findItemBag(player, 1393);
        Item biaSach = InventoryService.gI().findItemBag(player, 1389);
    ...
    public static void cheTaoCuonSachCu(Player player) {
        if (InventoryService.gI().getCountEmptyBag(player) == 0 && InventoryService.gI().findItemBag(player, 1392) == null) {
        ...
        if (Util.isTrue(20, 100)) {
            ...
            InventoryService.gI().addItemBag(player, cuonSachCu,999999);
