...
public class DoiSachTuyetKy {
    ...
    public static void showCombine(Player player) {
        Item cuonSachCu = InventoryService.gI().findItemBag(player, 1392);
        Item kimBamGiay = InventoryService.gI().findItemBag(player, 1390);
    ...
    public static void doiSachTuyetKy(Player player) {
        ...
        if (Util.isTrue(20, 100)) {
            ...
            InventoryService.gI().addItemBag(player, sachTuyetKy,999999);
