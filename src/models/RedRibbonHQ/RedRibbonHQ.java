...
public class RedRibbonHQ implements Runnable {
    ...
    private void init() {
        ...
        for (Zone zone : this.zones) {
            ...
            if (zone.map.mapId == 62) {
                try {
                    long bossDamage = (dame * 11 /10);
                    long bossMaxHealth = (hp * 11/10);
            ...
            if (zone.map.mapId == 55) {
                try {
                    long bossDamage =(long) (dame * 115/100);
                    long bossMaxHealth = (hp * 115 /100);
            ...
            if (zone.map.mapId == 54) {
                try {
                    long bossDamage =dame * 12/10;
                    long bossMaxHealth = hp * 12/10;
            ...
            if (zone.map.mapId == 57) {
                try {
                    long bossDamage = (dame * 13/10);
                    long bossMaxHealth = hp * 13/10;
                    for (int i = 0; i < 4; i++) {
    ...
    public ItemMap NR(Zone zone) {
        ...
        int nr = Util.isTrue(1, 500) ? Util.nextInt(925, 927) : Util.nextInt(928, 931);
