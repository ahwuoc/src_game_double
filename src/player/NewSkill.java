...
public class NewSkill {
    ...
    public void setSkillSpecial(byte dir, short _xPlayer, short _yPlayer, short _xObjTaget, short _yObjTaget) {
        if (player.inventory.itemsBody.get(11).template != null) {
            typeGong = 2;
            
            if(player.inventory.itemsBody.get(11).isSachTuyetKy2()){
                typePaint = 2;
            }else{
                typePaint = 0;
            }
        ...
        int dx = skillSelect.dx +  24 * skillSelect.point;// dir * (skillSelect.point * 100 + 100);
