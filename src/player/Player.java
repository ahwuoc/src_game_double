...
public class Player implements Runnable {
    ...
    public Player() {
        phucLoi = new PhucLoi[1000];
        mocPhucLoi = new int[]{0, 0, 0, 0, 0};
    ...
    public boolean isClientDoubleMessage() {
        return this.session != null && this.session.version == 999;
    }
...
//                    }
                    ...
                    if (this.isPl() && this.nPoint.power >= 0 && this.nPoint.power <= 100000000000l) {
