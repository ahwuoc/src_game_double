...
public class SummonDragon {
    ...
    public static final short NGOC_RONG_SIEU_CAP = 20000;
        ...
        if (pl.zone.map.mapId == 5) {
            if (checkShenronBall(pl, DRAGON_BLACK_SHENRON)) {
                ...
                if (Util.canDoWithTime(lastTimeShenronAppeared, timeResummonShenron)) {
                    ...
                    playerSummonShenronId = (int) pl.id;
                    mapShenronAppear = pl.zone;
                    InventoryService.gI().subQuantityItemsBag(pl, InventoryService.gI().findItemBag(pl, NGOC_RONG_SIEU_CAP), 1);
                    InventoryService.gI().sendItemBag(pl);
    ...
    public void confirmWish() {
        switch (this.menuShenron) {
                    ...
                    case 0: //đẹp trai nhất vũ trụ
                        if (playerSummonShenron != null) {
                            if (InventoryService.gI().getCountEmptyBag(playerSummonShenron) > 0) {
                                ...
                                avtVip.itemOptions.add(new ItemOption(50, Util.nextInt(5, 10)));
                                avtVip.itemOptions.add(new ItemOption(77, Util.nextInt(10, 20)));
                                 avtVip.itemOptions.add(new ItemOption(103, Util.nextInt(10, 20)));
                                 avtVip.itemOptions.add(new ItemOption(210, Util.nextInt(1, 2)));
                                 avtVip.itemOptions.add(new ItemOption(237, Util.nextInt(1, 2)));
                                  avtVip.itemOptions.add(new ItemOption(93, Util.nextInt(1, 20)));
            ...
            case ConstNpc.ICE_SHENRON:
                switch (this.select) {
                   case 0: // 500k sdg
                      this.playerSummonShenron.nPoint.dameg += 100;
                      Service.gI().point(playerSummonShenron);
                      
                        break;
                    case 1: //500k hpg
                     this.playerSummonShenron.nPoint.hpg += 500;
                        Service.gI().point(this.playerSummonShenron);
                        break;
                    case 2: //500k giáp
                      this.playerSummonShenron.nPoint.defg += 50;
                        Service.gI().point(this.playerSummonShenron);
                        break;
                    case 3: //500k ki
                       this.playerSummonShenron.nPoint.mpg += 500; //critg
                        Service.gI().point(this.playerSummonShenron);
                        break;
                         case 4: //500k ki
                       this.playerSummonShenron.nPoint.critg += 1; //critg
                        Service.gI().point(this.playerSummonShenron);
                        break;
