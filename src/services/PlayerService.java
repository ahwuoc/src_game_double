...
public class PlayerService {
        ...
        if (param > 0) {
            ...
            try {
                ...
                if (player.isClientDoubleMessage()) {
                    ...
                    msg.writer().writeInt(Util.maxInt(param));// số tn cần cộng
                }
    ...
    private static final int COST_GOLD_HOI_SINH = 100000000;
    private static final int COST_GEM_HOI_SINH = 1000;
    private static final int COST_GOLD_HOI_SINH_NRSD = 2000000000;
