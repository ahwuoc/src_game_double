            ...
            switch ((int) boss.id) {
                ...
                case BossID.FIDE:
                    switch (boss.currentLevel) {
                        case 0 -> doneTask(player, ConstTask.TASK_23_0);
                        case 1 -> doneTask(player, ConstTask.TASK_23_1);
                        case 2 -> doneTask(player, ConstTask.TASK_23_2);
                    }
                    break;
                ...
                case BossID.XEN_BO_HUNG:
                    switch (boss.currentLevel) {
                        case 0 -> doneTask(player, ConstTask.TASK_28_1);
                        case 1 -> doneTask(player, ConstTask.TASK_28_2);
                        case 2 -> doneTask(player, ConstTask.TASK_28_3);
                    }
                    break;
        ...
        if (TaskService.gI().isCurrentTask(player, idTaskCustom)) {
            ...
            switch (idTaskCustom) {
                ...
                case ConstTask.TASK_10_2:
                    ...
                    InventoryService.gI().addItemBag(player, ngocrong6sao,999999);
                ...
                case ConstTask.TASK_30_7:
                    npcSay(player, ConstNpc.OSIN,
                            "Mabu cuối cùng cũng đã bị tiêu diệt, hòa bình đã đến với toàn cõi vũ trụ, cậu đúng là cứu tinh của nhân loại");
            ...
            if (player.playerTask.sideTask.isDone()) {
                ...
                if (InventoryService.gI().getCountEmptyBag(player) > 1) {
                    if (cayThong != -1 && canNhanCayThong) {
                        ...
                        InventoryService.gI().addItemBag(player, cT,999999);
                        ...
                        InventoryService.gI().addItemBag(player, bi,999999);
